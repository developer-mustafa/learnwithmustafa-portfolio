      ...
      <div className="containerCustom gap overflow-hidden">
        ...
        <div className="md:grid items-center md:gap-3 lg:gap-4 grid-cols-9 md:col-start-9">
          <div className="md:col-span-5 lg:col-span-5 lg:pr-28">
            <Fade up cascade>
              <h3>Hello! I Am Mustafa Rahman.</h3>{" "}
              <p className="text-sm">
                As an experienced front-end developer with React.JS,Node.JS I have been
                actively involved in web development since 2015. My skill set
              ...
              <div className="mt-5">
                <Fade up>
                  <Info name="email" details="mustafarahman792@gmail.com" />
                  <Info name="phone" details="+8801840643946" />
                  <Info name="address" details="Mirsarai,Chattogram, Bangladesh" />
          ...
          <Zoom>
            <div className="h-auto w-full mt-5 md:mt-0 overflow-hidden rounded-xl md:col-span-4 lg:col-span-4 aspect-[auto]">
              <img src={picture} alt="" className="w-full" />
            </div>{" "}
          </Zoom>
        </div>
