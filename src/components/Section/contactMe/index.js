            ...
            <div className="w-full p-4 bg-white border rounded-lg shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700">
              ...
              <ul className="my-4 space-y-3">
                <SocialContact
                  ...
                  name="email"
                  link="mailto:mustafarahman792@gmail.com"
                  delay={100}
                />
                <SocialContact
                  icon="fa-brands fa-whatsapp"
                  name="whatsapp"
                  link="https://wa.me/+8801840643946/"
                  delay={150}
                />
                <SocialContact
                  icon="fa-brands fa-facebook-messenger"
                  name="messenger"
                  link="https://www.messenger.com/t/mustafa24hours"
                  delay={200}
                />
                <SocialContact
                  icon="fab fa-line"
                ...
                <SocialContact
                  ...
                  name="linkedin"
                  link="https://www.linkedin.com/in/developer-mustafa/"
                  delay={250}
                />
                <SocialContact
                  icon="fab fa-twitter"
                  name="twitter"
                  link="https://twitter.com/developer-mustafa"
                  delay={300}
                />
                <SocialContact
                  icon="fab fa-instagram"
                  name="instagram"
                  link="https://www.instagram.com/developer-mustafa/"
                  delay={350}
                />
              </ul>
            </div>
